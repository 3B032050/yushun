            ...
            <div class="d-flex justify-content-between align-items-center">
                <nav aria-label="breadcrumb" class="mb-2 mb-md-0">
                    <ol class="breadcrumb breadcrumb-path">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">新增使客戶資料</li>
                    </ol>
                </nav>
        ...
        <div id="content" class="font-medium">
            <div class="row justify-content-center">
                <div class="col-12 col-md-10 col-lg-8">
                    <div class="card">
                        <div class="card-header text-center">{{ __('新增客戶資料') }}</div>
                            ...
                            <form method="POST" action="{{ route('admins.users.store') }}" enctype="multipart/form-data">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-6">
                                        <input id="name" type="text"
                                               ...
                                               name="name" value="{{ old('name') }}" required placeholder="請輸入姓名" autofocus>
                                        @error('name')
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-6">
                                        <input id="email" type="email"
                                               ...
                                               name="email" value="{{ old('email') }}" required placeholder="請輸入 Email">
                                        @error('email')
                                        <span class="invalid-feedback" role="alert"><strong>{{ $message }}</strong></span>
                                        @enderror
                                    </div>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-6">
                                        <input id="mobile" type="text"
                                               ...
                                               name="mobile" value="{{ old('mobile') }}" required placeholder="請輸入手機號碼">
                                        @error('mobile')
                                        <span class="invalid-feedback" role="alert"><strong>{{ $message }}</strong></span>
                                        @enderror
                                    </div>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-6">
                                        <input id="phone" type="text"
                                               ...
                                               name="phone" value="{{ old('phone') }}" placeholder="請輸入電話（可留空）">
                                        @error('phone')
                                        <span class="invalid-feedback" role="alert"><strong>{{ $message }}</strong></span>
                                        @enderror
                                    </div>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-6">
                                        <input id="address" type="text"
                                               ...
                                               name="address" value="{{ old('address') }}" required placeholder="請輸入地址">
                                        @error('address')
                                        <span class="invalid-feedback" role="alert"><strong>{{ $message }}</strong></span>
                                        @enderror
                                    </div>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-6">
                                        <input id="line_id" type="text"
                                               ...
                                               name="line_id" value="{{ old('line_id') }}" placeholder="請輸入 LINE ID（可留空）">
                                        @error('line_id')
                                        <span class="invalid-feedback" role="alert"><strong>{{ $message }}</strong></span>
                                        @enderror
                                    </div>
                                ...
                                <div class="row mb-0">
                                    <div class="col-md-8 offset-md-4">
                                        ...
                                        <button type="button" class="btn btn-secondary" onclick="window.location.href='{{ route('admins.users.index') }}'">
                                            返回
                                        </button>
                                    </div>
                                </div>
